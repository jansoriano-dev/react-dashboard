...
class Sidebar extends Component {
  ...
  onRouteChanged() {
    ...
    const dropdownPaths = [
      ...
      {path:'/customer', state: 'CustomerPagesMenuOpen'},
      {path:'/courier', state: 'CourierPagesMenuOpen'},
        ...
        <ul className="nav">
          ...
          <li className={ this.isPathActive('/customer') ? 'nav-item active' : 'nav-item' }>
            <div className={ this.state.CustomerPagesMenuOpen ? 'nav-link menu-expanded' : 'nav-link' } onClick={ () => this.toggleMenuState('CustomerPagesMenuOpen') } data-toggle="collapse">
              <span className="menu-title"><Trans>Customer</Trans></span>
              <i className="menu-arrow"></i>
              <i className="mdi mdi-account-group menu-icon"></i>
            </div>
            <Collapse in={ this.state.CustomerPagesMenuOpen }>
              <ul className="nav flex-column sub-menu">
                <li className="nav-item"> <Link className={ this.isPathActive('/customer/custInfo') ? 'nav-link active' : 'nav-link' } to="/customer/custInfo"><Trans>Details</Trans></Link></li>
                <li className="nav-item"> <Link className={ this.isPathActive('/customer/custOrderInfo') ? 'nav-link active' : 'nav-link' } to="/customer/custOrderInfo"><Trans>Orders</Trans></Link></li>
              </ul>
            </Collapse>
          </li>
          <li className={ this.isPathActive('/courier') ? 'nav-item active' : 'nav-item' }>
            <div className={ this.state.CourierPagesMenuOpen ? 'nav-link menu-expanded' : 'nav-link' } onClick={ () => this.toggleMenuState('CourierPagesMenuOpen') } data-toggle="collapse">
              <span className="menu-title"><Trans>Courier</Trans></span>
              <i className="menu-arrow"></i>
              <i className="mdi mdi-truck-delivery menu-icon"></i>
            </div>
            <Collapse in={ this.state.CourierPagesMenuOpen }>
              <ul className="nav flex-column sub-menu">
                <li className="nav-item"> <Link className={ this.isPathActive('/courier/courInfo') ? 'nav-link active' : 'nav-link' } to="/courier/courInfo"><Trans>Info</Trans></Link></li>
              </ul>
            </Collapse>
          </li>
